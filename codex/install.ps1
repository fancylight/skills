...
if (Test-Path -LiteralPath $sharedTemplatesDir) {
    ...
    @('validate-test-artifacts.ps1', 'test-scope-guard.ps1', 'validate-domain-artifact.ps1', 'validate-test-cases.ps1', 'flow-test-controller.ps1', 'resolve-test-environment.ps1', 'validate-test-environment.ps1', 'migrate-test-environment-manifest.ps1', 'check-java-style.ps1') | ForEach-Object {
